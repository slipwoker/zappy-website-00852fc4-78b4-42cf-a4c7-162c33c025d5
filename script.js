  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if ((type === 'text' || tagName === 'textarea') && field.maxLength > 0 && value.length > field.maxLength) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לילילה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '00852fc4-78b4-42cf-a4c7-162c33c025d5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '00852fc4-78b4-42cf-a4c7-162c33c025d5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '00852fc4-78b4-42cf-a4c7-162c33c025d5';
